...
typedef struct sll* SimpleLinkedCircularQueue;
...
void sllReplaceS(SimpleLinkedCircularQueue queue, void* data, const unsigned int index, DeallocFunction function);
